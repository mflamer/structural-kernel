...
| [0014](0014-concrete-framing-dimensioned-members.md) | Concrete framing: dimensioned members (b×h + structured reinforcement, single-pass authored-and-checked) register the third family; the ADR 0007 boundary confirmed with one additive request-field finding | Accepted 2026-07-10 (note 0006) |
